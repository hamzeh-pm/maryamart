    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(max_length=10, unique=True, verbose_name='cellphone_number')),
                ('name', models.CharField(max_length=255)),
                ('role', models.CharField(choices=[('CL', 'Client'), ('AR', 'Artist'), ('AD', 'Admin')], default='CL', max_length=2)),
